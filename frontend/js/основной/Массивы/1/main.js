...
//* concat() - сложение массив 
//* includes() true  false если есть или нет элемент в массиве
//* split() разбивает строку в массив 
//* join() склеивает в строку

//* flat()  убирает массив в массивке
//* reverse() разварачивает массив
...
const fromYouArray = fromYou.split(',')
const newArray = []
console.log(newArray)
fromYouArray.forEach((element) =>{
    newArray.push('#'+element.toLowerCase().split(''));
